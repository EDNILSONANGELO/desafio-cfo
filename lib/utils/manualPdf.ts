...
export const PROFESSOR_PDF: PdfSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullet", text: "Capacidade efetiva — fábrica base (5.000 un.) + máquinas acumuladas de rodadas anteriores." },
...
export const STUDENT_PDF: PdfSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "bullet", text: "Capacidade produtiva — calculada automaticamente: 5.000 un. base + máquinas acumuladas." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "body", text: "Comprar máquinas é a única forma de aumentar a capacidade da fábrica além das 5.000 unidades base. O investimento vira Ativo Imobilizado e é depreciado em 60 meses." },
      ...
      { type: "bullet", text: "Capacidade efetiva = 5.000 (base) + total acumulado de todas as máquinas compradas." },
